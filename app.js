...
// will replace this with chatgpt api when i get it
...
app.get('/api/scorequestion', async (req,res)=>{
    ...
    Have 'yes' or 'no' as the first word in your response. Include in your response
    out of a 100% how right the answer was.`
    // send prompt to chatgpt
